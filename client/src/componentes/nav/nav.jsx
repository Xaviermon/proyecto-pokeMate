...
import perfil from '../../imagenes/exitPokemon.png'


const navigation = [
  { name: 'Home', href: '#', current: false },
  { name: 'Ejercicios', href: '/ejercicios', current: false },
                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      <Link
                        ...
                        aria-current={item.current ? 'page' : "location"}
                      >
                        {item.name}
                      </Link>
                    ))}
